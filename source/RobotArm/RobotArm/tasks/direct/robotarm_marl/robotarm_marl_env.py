...
from .robotarm_marl_env_cfg import RobotarmMarlEnvCfg


class RobotarmMarlEnv(DirectMARLEnv):
    cfg: RobotarmMarlEnvCfg

    def __init__(self, cfg: RobotarmMarlEnvCfg, render_mode: str | None = None, **kwargs):
